...
const Delivery = () => {
  const deliveryOptions = [
    ...
    },
    {
      ...
      price: "от 500₽",
      icon: "Truck",
      features: ["Удобное время доставки", "Бесплатно от 50 000₽"],
    },
    {
      title: "Самовывоз",
      time: "В любое рабочее время",
      price: "Бесплатно",
      icon: "Store",
      features: [
        "ул. Элеваторная 4",
  ...
  const zones = [
    { zone: "В пределах Симферополя", price: "1000₽", time: "В день заказа" },
    { zone: "до 50км", price: "3000₽", time: "1-2 дня" },
    { zone: "от 100 км от Симферополя", price: "4000₽", time: "2-3 дня" },
  ];
