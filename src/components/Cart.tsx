  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (hasStockIssues) {
      toast({
        ...
        description:
          "Проверьте количество товаров в корзине - превышено наличие на складе",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const response = await fetch(
        "https://functions.poehali.dev/c586c98b-e013-4b6b-8063-e0103c9781b4",
        {
          method: "POST",
        ...
        {items.length === 0 ? (
          ...
          <div className="space-y-6 mt-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="productRequest">
                  Нужен товар, которого нет в каталоге? Наберите нас, и мы
                  постараемся найти его для вас!
                </Label>
                <Textarea
                  id="productRequest"
                  value={formData.productRequest}
                  onChange={(e) =>
                    setFormData({ ...formData, productRequest: e.target.value })
                  }
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-red-800">
                      Некоторые товары превышают доступное количество на складе.
                      Уменьшите количество для оформления заказа.
                    </p>
                  </div>
                </div>
              )}
